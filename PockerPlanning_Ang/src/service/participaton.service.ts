...
export class ParticipatonService {
  ...
  public getParticipations(): Observable<Participation[]> {
    return this.httpClient.get<Participation[]>('http://localhost:8080/participation/getall')
      .pipe(
  ...
  addParticipation(participation: Participation, eventId: number) {
    ...
    return this.httpClient.post(`http://localhost:8080/participation/add/${eventId}`, participation);
  }
  public deleteParticipation(id: number) {
    return this.httpClient.delete(`http://localhost:8080/participation/delete/${id}`);
  }
  public updateParticipation(id: number, a: Participation){
    return this.httpClient.put(`http://localhost:8080/participation/update/${id}`,a);
  }
  public retrieveParticipation(id:number){
    return this.httpClient.get<Participation>(`http://localhost:8080/participation/getbyid/${id}`)
  }
}
